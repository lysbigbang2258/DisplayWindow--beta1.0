...
namespace ArrayDisplay.DataUtl {
...
//        public const int WORK_FRAME_NUMS = 31250; //正常工作波形同时显示帧数
        public const int WORK_FRAME_NUMS = 31250; //正常工作波形同时显示帧数 31.25k采样率，取1/10秒

        public const int WORK_SAVE_PACK_PER = 10;
        public const int WORK_FRAME_LENGTH = 256; // 正常工作波形帧长 64 * 4
        //能量图像素长度
